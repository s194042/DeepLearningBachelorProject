...
class MakeIter(torch.utils.data.IterableDataset):
    ...
    def __iter__(self):
        ...
        if self.startup:
            return iter(get_images_without_flips_and_cuts(path = 'C:/Users/Rani/Desktop/ai_training_immages/' + self.folder))
        else:
            return iter(get_images(path = 'C:/Users/Rani/Desktop/ai_training_immages/' + self.folder, epoch=self.epoch))
